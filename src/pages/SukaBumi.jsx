...
const SukaBumi = () => {
  return (
    <>
      <NavbarHome />
      <h1 className='text-center font-bold text-2x1 text-gray-800 pt-5 text-[22px]'>Pasang Indihome SukaBumi Di Tahun 2022 Dan Rilis Terbaru</h1>
      <div className='container mx-auto px-2 max-w-5xl pt-5 md:pt-32'>
        <img className='w-[60%] mx-auto' src="./IndiHome-Solo.jpg" alt="" />
        <p className='pt-3 pb-2 text-justify'>Suatu Berita Menguntungkan bagi Kamu  Dan Keluarga Kamu yang memerlukan pemasangan Indihome .Segera Daftar  Indihome SukaBumi Di  Tahun 2022 secara cepat dan mudah dengan menggunakan website pemasangan Indihome yang kami sediakan untuk kamu ingin memasang wifi indihome di rumah/kantor dan kamar apartemen kamu .</p>
        <p className='pt-2 pb-2 text-justify'>Silahkan hidupkan handphone mu lalu  hubungi sales/marketing resmi Indihome Fiber (Speedy) Telkom SukaBumi melalui website ini untuk pasang WIFI Indihome di rumah/kantor dan kamar apartemen Kamu.</p>
        ...
        <h1 className='text-center font-bold pt-2'>Harga Paket Indihome SukaBumi Tahun 2022</h1>
        <p className='pt-2 pb-2 text-justify'>Semua harga paket indihome SukaBumi 2022 yang kami tampilkan merupakan produk terbaik dan terbaru</p>
        <p className='pt-2 pb-2 text-justify'>Silahkan Kawan, Kerabat, Saudara semuanya silahkan call , sms , WA, tidak usah datang dan antri di plasa TELKOM cukup kontak kami dan kami akan datang ke tempat anda. Kami akan informasikan Paket-paket lain yang lebih terjangkau dan HARGA PROMO untuk wilayah tertentu.</p>
        <Paket />
        <h1 className='text-center font-bold p-4'>Paket 3P (PAKET TRIPLE PLAY)</h1>
        <p className='pb-2'>Paket promo 3P adalah merupakan paket Triple Play yang terdiri atas:</p>
        ...
        <p className='pb-2'>Dengan harga promo paket Speedy Indihome di SukaBumi Tahun 2022 Paket 3P memiliki fitur sebagai berikut:</p>
        <ul className='list-disc ml-5 pb-2'>
          <li>Internet kuota Unlimited (FUP)</li>
          <li>Speed 30 Mbps hingga 300 Mbps (Harga bulanan berbeda-beda)</li>
          <li>Sudah termasuk sewa Modem WIFI</li>
          <li>Bebas Nelpon 50 Menit</li>
          <li>Ekstra 57 Channel TV ( 3 Bulan )</li>
          <li>Bebas Akses UseeTV GO</li>
          <li>Cash Back LinkAja Rp 100.000</li>
        </ul>
        <p className='pb-2'>Harga paket Indihome 3P:</p>
        <ul className='list-disc ml-5 pb-2'>
          <li>Biaya berlangganan per bulan:</li>
          <li className='ml-5'>Speed 30 Mbps: Rp 385.000 (belum Termasuk PPn 11%)</li>
        ...
        <h1 className='font-bold text-center p-4'>Paket 2P (Paket Internet dan Telpon)</h1>
        ...
        <ul className='list-disc ml-5 pb-2'>
          <li>Internet kuota Unlimited (FUP)</li>
          <li>Speed 30 Mbps hingga 100 Mbps (Harga bulanan berbeda-beda)</li>
          <li>Sudah termasuk sewa Modem WIFI</li>
          <li>Gratis telepon lokal dan SLJJ 50 menit</li>
          <li>Cash Back LinkAja Rp 100.000 Ribu</li>
          <li>Diskon 50% Biaya Pemasangan</li>
        </ul>
        <p className='pb-2'>Biaya paket Indihome 2P Internet Telepon:</p>
        <ul className='list-disc ml-5 pb-2'>
          <li>Biaya berlangganan per bulan:</li>
          <li className='ml-5'>Speed 30 Mbps: Rp 315.000  (belum Termasuk PPn 11%)</li>
        ...
        <h1 className='font-bold text-center p-4'>Biaya Tarif Pasang Baru Indihome SukaBumi Tahun 2022</h1>
        <p className='pb-2'> secara harga biaya atau tarif pemasangan baru Indihome di SukaBumi adalah sebagai berikut:</p>
        <ul className='list-disc ml-5 pb-2'>
