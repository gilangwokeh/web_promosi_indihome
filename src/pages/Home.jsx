...
const Home = () => {
  return (
    <>
      <NavbarHome />
      <h1 className='text-center font-bold text-2x1 text-gray-800 pt-5 text-[22px]'>Daftar Indihome Tangerang Di Tahun 2024 Dan Tahun 2025 Rilis Terbaru</h1>
      <div className='container mx-auto px-2 max-w-5xl pt-5 md:pt-32'>
        ...
        <h2 className='text-center font-bold pt-2'>Harga Paket Indihome Tangerang Tahun 2024 Dan Tahun 2025 </h2>
        ...
        <Paket />
        <h3 className='text-center font-bold p-4'>Paket 3P (PAKET TRIPLE PLAY)</h3>
        ...
        <p className='pb-2'>Dengan harga promo paket Speedy Indihome di Tangerang Tahun 2024 Dan Tahun 2025  Paket 3P memiliki fitur sebagai berikut:</p>
        <ul className='list-disc ml-5 pb-2'>
