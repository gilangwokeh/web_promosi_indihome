  ...
  return (
    <>
      ...
      <div className='container mx-auto px-2 max-w-5xl pt-5 md:pt-32'>
        ...
        <p className='pb-2'> secara harga biaya atau tarif pemasangan baru Indihome di Tangerang adalah sebagai berikut:</p>
        <ul className='list-disc ml-5 pb-2'>
